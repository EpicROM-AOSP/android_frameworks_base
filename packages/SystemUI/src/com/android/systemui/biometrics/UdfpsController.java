...
import com.android.internal.util.epic.udfps.CustomUdfpsUtils;
...
public class UdfpsController implements DozeReceiver, Dumpable {
    ...
    private void updateUdfpsAnimation() {
        if (com.android.internal.util.epic.EpicUtils.isPackageInstalled(mContext,
                "com.epic.udfps.animations")) {
