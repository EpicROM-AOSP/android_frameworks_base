...
import com.android.internal.util.epic.OmniJawsClient;
    ...
    protected void handleClick(@Nullable View view) {
        ...
        if (!mState.value || mWeatherData == null) {
            ...
            for (String app: ALTERNATIVE_WEATHER_APPS) {
                if (EpicUtils.isPackageInstalled(mContext, app)) {
            ...
            if (EpicUtils.isPackageInstalled(mContext, "com.google.android.googlequicksearchbox")) {
