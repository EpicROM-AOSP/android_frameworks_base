...
package com.android.systemui.epic.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.epic.header.STATUS_BAR_HEADER_UPDATE";
