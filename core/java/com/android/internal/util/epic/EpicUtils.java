...
public class EpicUtils {
    ...
    private static final String TAG = EpicUtils.class.getSimpleName();
	...
	try {
	    Runtime.getRuntime().exec(command).waitFor();
            ...
            System.err.println("EpicUtils: Error changing dpi");
            e.printStackTrace();
    ...
    public static void toggleRingerModes (Context context) {
        ...
        public static boolean updateLayout(Context context) {
            ...
            for (int i = 0; i < 2; ++i) {
                String pkgName;
                if (i == 0) {
                    pkgName = String.format("com.epic.qs.portrait.layout_%sx%s", Integer.toString(row_qs), Integer.toString(col_qs));
                } else {
                    pkgName = String.format("com.epic.qqs.portrait.layout_%sx%s", Integer.toString(row_qqs), Integer.toString(col_qs));
                }
                try {
